        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
            ...
            <div className="p-4 md:w-1/2 sm:mb-0 mb-6">
              ...
              <p className="text-base leading-relaxed mt-2">
                Easily create credit cards of various companies for testing..{" "}
              </p>
              <Link href="/misc/credit-card-gen">
                <a className="text-yellow-400 inline-flex items-center mt-3">
                  Learn More
                  <svg
                    fill="none"
        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
            <div className="p-4 md:w-1/2 sm:mb-0 mb-6">
              ...
              <p className="text-base leading-relaxed mt-2">
                A tool to help you come up with excuses.
              </p>
              <Link href="/fun/excuser">
                <a className="text-yellow-400 inline-flex items-center mt-3">
                  Learn More
                  <svg
                    fill="none"
            ...
            <div className="p-4 md:w-1/2 sm:mb-0 mb-6">
              ...
              <p className="text-base leading-relaxed mt-2">
                A fun trvia quiz on computer science.{" "}
              </p>
              <Link href="/fun/quiz">
                <a className="text-yellow-400 inline-flex items-center mt-3">
                  Learn More
