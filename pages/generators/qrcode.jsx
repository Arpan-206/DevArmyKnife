        ...
        <div class="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <div class="relative mb-4">
            ...
            <textarea
              ...
              class="w-full bg-gray-800 rounded border border-gray-700 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-900 h-32 text-base outline-none text-gray-100 py-1 px-3 reFrontColor-none leading-6 transition-colors duration-200 ease-in-out"
            ></textarea>
          </div>
          <div class="relative mb-4">
            <label for="FrontColor" class="leading-7 text-sm text-gray-400">
              Front Color (Without #)
            </label>
            <input
              id="FrontColor"
              ...
              class="w-full bg-gray-800 rounded border border-gray-700 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-900 h-16 outline-none text-gray-100 py-1 px-3 reFrontColor-none leading-6 transition-colors duration-200 ease-in-out"
            ></input>
          </div>
          <div class="relative mb-4">
            <label for="BackColor" class="leading-7 text-sm text-gray-400">
              Back Color (Without #)
            </label>
            <input
              id="BackColor"
          ...
          <p class="text-xs text-yellow-300 text-opacity-90 mt-3">
